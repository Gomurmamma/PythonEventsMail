...
class UserInputs:
    ...
    def get_user_event_type_preference(self):
        ...
        event_type = input("What event type are you looking for? (Options: 'concert', 'sports', 'comedy',)")
    ...
    def get_user_location_preference(self):
        ...
        print("Where are you looking for events?")
    ...
    def get_user_range_preference(self):
        ...
        self._radius = int(input("How many miles should the search range be from your location? (Enter a positive integer): "))
