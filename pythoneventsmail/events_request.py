"""
Defines EventsRequest class for requesting events from the SeatGeek API
"""
import os
    ...
    def get_events(self):
        ...
        try:
            response = requests.get(
                f"https://api.seatgeek.com/2/events?lat={lat}&lon={lon}&range={radius}mi\n"
                f"&client_id={client_id}&type={event_type}&&client_secret={client_secret}",
                timeout=5,
            )
            ...
            for event in events:
                ...
                formatted_event = {
                    ...
                    "formatted_ticket_url": ticket_url,
                    "formatted_month": event_month,
                    "formatted_day": str(event_day),
                    "formatted_venue_name": venue_name,
                    "formatted_city": city,
                    "formatted_state": state,
                    "formatted_image_url": image_url,
                }
            ...
            print(
                "There was an error with the request for the events you've specified."
            )
